...
bool ReportGenerator::generateReportFromProcessedData(const Warehouse& warehouse, 
    ...
    outFile << generateOrdersSection(warehouse, aux);
    outFile << generateItemsSection(warehouse, aux);
...
std::string ReportGenerator::generateOrdersSection(const Warehouse& warehouse, const AuxiliaryStructures& aux) {
    std::stringstream ss;
    
    ss << "    <div class=\"section\">\n"
       << "        <h2>Análise de Pedidos</h2>\n";
    
    // Tabela dos top 20 pedidos mais eficientes
...
std::string ReportGenerator::generateItemsSection(const Warehouse& warehouse, const AuxiliaryStructures& aux) {
    std::stringstream ss;
